...
class ApidataController extends CController
{
	...
	if($r['status']==3){
		...
		$chkb="SELECT TRIM(branchname) AS branchname FROM msystem.sysuser WHERE name='".$r['per_id']."'";
		$br=Yii::app()->msystem->createCommand($chkb)->queryRow();
		...
		$sqlbr6="SELECT TRIM(branchname) AS branchname FROM msystem.sysuser WHERE name='".$r['per_id']."'";
		$br6=Yii::app()->msystem->createCommand($sqlbr6)->queryRow();
		$records[]=array(
			'step'=>$r['status'],
			'stepname'=>$r['stepname'],
			'authorid'=>$r['per_id'],
		...
		$sqlbr5="SELECT TRIM(branchname) AS branchname FROM msystem.sysuser WHERE name='".$r['per_id']."'";
		$br5=Yii::app()->msystem->createCommand($sqlbr5)->queryRow();
		$records[]=array(
			'step'=>$r['status'],
			'stepname'=>$r['stepname'],
			'authorid'=>$r['per_id'],
		...
		$sqlbr4="SELECT TRIM(branchname) AS branchname FROM msystem.sysuser WHERE name='".$r['per_id']."'";
		$br4=Yii::app()->msystem->createCommand($sqlbr4)->queryRow();
